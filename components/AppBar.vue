<template>
    <nav class="flex w-full items-center justify-between flex-wrap bg-green-500 p-6">
        <a href="https://tailwindcss.com/" class="flex items-center flex-shrink-0 text-white mr-6">   
